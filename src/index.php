        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-7">
                    <div class="main-text">
                        <h1 id="main-text" class="main-text__title wow fadeInDown " data-wow-delay="0.2s">Производство упаковки из гофрокартона</h1>
                        <div class="main-text__subtitle wow fadeInDown " data-wow-delay="0.2s">с доставкой по всей Росси</div>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="products-block wow fadeInDown " data-wow-delay="0.1s">
                        <img class="products-block__img" src="img/12.png" alt="">
                ...
                <div class="col-12 col-md-6">
                    <div class="products-block wow fadeInDown " data-wow-delay="0.2s">
                        <img class="products-block__img" src="img/13.png" alt="">
                        <div class="products-block__title">
                            Гофролоток 
                        </div>
                        <div class="products-block__buttons"><button class="button button-0 products-block__button">Подробнее</button><button class="button">Получить расчет</button></div>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="products-block wow fadeInDown " data-wow-delay="0.3s">
                        <img class="products-block__img" src="img/14.png" alt="">
                        <div class="products-block__title">
                ...
                <div class="col-12 col-md-6">
                    <div class="products-block wow fadeInDown " data-wow-delay="0.4s">
                        <img class="products-block__img" src="img/15.png" alt="">
                        <div class="products-block__title">
